...
(
    ...
    function ()
    {
        ...
        (
            ...
            function ()
            {
                var subrequireId = require.resolve('..');
                var subrequire = require('..');
